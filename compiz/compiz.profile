...
as_command10 = 
as_command11 = 
as_run_command0_key = <Super>space
...
as_next_button = Button8
as_prev_key = <Super>q
as_prev_button = Button9
...
s0_speed = 5.025900
s0_shift_speed = 2.163200
s0_timestep = 1.200000
s0_window_match = (Normal | Dialog | ModalDialog | Utility | Unknown) & !(title=VMware) & !(title=Network Connect) & !(name=Pidgin)
s0_minimized = true
...
s0_close_effects = animation:Glide 2;animationaddon:Burn;animation:Fade;animation:Fade;
s0_close_durations = 101;200;150;150;
s0_close_matches = class=Guake;(type=Normal | Dialog | ModalDialog | Unknown) & !(name=gnome-screensaver);(type=Menu | PopupMenu | DropdownMenu);(type=Tooltip | Notification | Utility) & !(name=compiz);
s0_close_options = ;;;;
s0_close_random_effects = 
s0_minimize_effects = animation:Magic Lamp;
s0_minimize_durations = 205;
...
as_rotate_left_button = Button6
as_rotate_right_key = <Control><Alt>Right
as_rotate_right_button = Button7
as_rotate_left_window_key = <Super>Left
as_rotate_left_window_button = Disabled
as_rotate_right_window_key = <Super>Right
...
s0_images = /usr/share/images/desktop-base/debian-blueish-wallpaper-640x480.png;
...
[core]
as_active_plugins = core;decoration;obs;screenshot;workarounds;commands;neg;wobbly;regex;gnomecompat;shift;animation;mousepoll;grid;png;winrules;resize;ring;place;cube;thumbnail;move;expo;ezoom;animationaddon;rotate;
