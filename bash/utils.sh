...
#::::::::::::::::::::YOUTUBE DOWNLOAD::::::::::::::::::::
#(youtube-dl became yt-dlp: Use `yt-dlp --compat-options youtube-dl` for some special cases)
...
#download a whole playlist and convert the audio into mp3:
  yt-dlp -x -f bestaudio[ext=m4a] --audio-format mp3 https://www.youtube.com/playlist?list=OLAK5uy_m6XppHGJtFY4ISTqrGEuYDiRrBJVEnveQ

#ERROR: unable to download video data: HTTP Error 403: Forbidden
  yt-dlp --rm-cache-dir

#Use cookie from browser for auth:
  yt-dlp https://www.instagram.com/reel/asdf/?igsh=asdf --cookies-from-browser vivaldi

#Use netrc:
  yt-dlp https://www.instagram.com/reel/asdf/?igsh=asdf -n
#In ~/.netrc:
  machine youtube login username password ******
